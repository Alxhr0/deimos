...
xbps-install -y -S base-devel wget git rust cargo go-md2man ostree libostree-devel pkgconf python3-setuptools
...
# Composefs
xbps-install -y -S openssl-devel fuse3-devel meson
cd /tmp
